...
<img src="docs/landing-v2.png" alt="Landing Page" width="900"/>

### 🗂️ Explorer View
> 3D card hover · Category sidebar · Live filter bar · Stats counters

<img src="docs/explorer-v2.png" alt="Explorer View" width="900"/>

### 👁️ API Preview Modal
> Live JSON fetch · Syntax highlighting · CORS proxy fallback · Response time

<img src="docs/modal-v2.png" alt="API Preview Modal" width="900"/>
